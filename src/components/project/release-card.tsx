          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div className="flex-1 space-y-2">
              ...
              <div className="flex flex-wrap items-center gap-2 text-xs sm:text-sm text-muted-foreground">
                <Badge variant="outline" className="text-xs">{release.tag_name}</Badge>
                <span>•</span>
                <span>
                        ...
                        <CardContent className="p-3 sm:p-4">
                          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between sm:gap-4">
                            <div className="flex-1 space-y-1">
                              <p className="break-all text-sm font-medium sm:text-base">{asset.name}</p>
                              <div className="flex flex-wrap gap-1.5 text-xs text-muted-foreground">
                                <span>{formatFileSize(asset.size)}</span>
                                <span>•</span>
                                <span>{dict.downloadCount}: {asset.download_count.toLocaleString()}</span>
                                <span className="hidden sm:inline">•</span>
                                <span className="hidden sm:inline">{asset.content_type}</span>
                              </div>
                            </div>
